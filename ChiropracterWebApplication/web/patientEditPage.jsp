<%-- 
    Document   : patientEditPage
    Created on : Oct 13, 2021, 10:53:24 PM
    Author     : lalu
--%>
...
border-radius: 25px;
  ...
  padding: 20px;" ></h1>
        ...
        <br><br><br><br>
        <form action="patientEditServlet" method="POST" id="aligned">
            <h2>
            ...
            <a href="patientViewAppointment.jsp">Back</a>
