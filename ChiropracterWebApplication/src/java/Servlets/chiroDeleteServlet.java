 ...
 * @author lalu
 */
@WebServlet(name = "chiroDeleteServlet", urlPatterns = {"/chiroDeleteServlet"})
public class chiroDeleteServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        System.out.println("chiro id is "+cid);
        
        DbAccess d1 = new DbAccess();
        d1.deleteAppointment(id);
        ...
        //response.sendRedirect("chiroViewAppointment.jsp");
